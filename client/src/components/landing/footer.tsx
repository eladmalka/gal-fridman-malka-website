  ...
  return (
    <footer className="bg-foreground text-background py-12">
      <div className="container px-4 text-center">
        ...
        <div className="flex justify-center gap-6 mb-8 text-background/80">
          <a href="mailto:galfridman21@gmail.com" className="hover:text-primary transition-colors">אימייל</a>
          <a href="tel:+972523491792" className="hover:text-primary transition-colors" dir="ltr">052-3491792</a>
        ...
        <div className="text-background/40 text-sm font-light">
